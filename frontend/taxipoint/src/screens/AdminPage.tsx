...
const AdminPage: React.FC<AdminPageProps> = ({ onLogout, user }) => {
  ...
  return (
  <div
  className="p-8 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 font-sans text-gray-200 min-h-screen overflow-y-auto"
          ...
          <tbody className="bg-gray-800 divide-y divide-gray-700">
            {taxiRanks.map((rank) => (
              ...
              >
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-300">
                  {Array.isArray(rank.routesServed)
