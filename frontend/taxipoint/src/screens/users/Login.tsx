  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-gradient-to-br from-gray-900 to-gray-800">
      ...
      <div className="flex flex-col justify-center items-center md:items-start p-8 md:p-16 w-full md:w-1/3 text-center md:text-left">
        <img src="/favicon.ico" alt="TaxiPoint Logo" className="w-24 h-24 md:w-32 md:h-32 mb-4" />
      ...
      <div className="flex justify-center items-center w-full md:w-2/3 p-8 md:p-16">
        <div className="bg-white/10 backdrop-blur-lg p-8 md:p-12 rounded-3xl shadow-lg w-full max-w-md border border-white/20 animate-fadeIn">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-6 text-center">Login</h2>

          <div className="space-y-3 mb-6">
            <button type="button" onClick={() => toast.info("Google login coming soon!")} className="flex items-center justify-center gap-2 w-full py-3 rounded-lg bg-white text-gray-800 font-semibold shadow-md hover:bg-gray-100 transition">
              <GoogleIcon /> Login with Google
            </button>
            <button type="button" onClick={() => toast.info("Facebook login coming soon!")} className="flex items-center justify-center gap-2 w-full py-3 rounded-lg bg-blue-600 text-white font-semibold shadow-md hover:bg-blue-700 transition">
